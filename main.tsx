...
const NO_PHRASES = [
  ...
  "I'll make you lemonade",
  "And Idli",
  "And make you a pizza(Not a Tania ofC)",
  "Mo pou demand to maman vin aide convaicre toi",
  "Plus to papa??",
  "Dhaveena??",
  "All of the above?",
  "mon plein aster, just click on YES",
  "Bon Mo sure to ena devoir, click yes ou al fr to devoir",
  "Bon Mo sure to ena devoir, click yes ou al fr to devoir",
  "Bon Mo sure to ena devoir, click yes ou al fr to devoir",
  "Bon Mo sure to ena devoir, click yes ou al fr to devoir",
  "Bon Mo sure to ena devoir, click yes ou al fr to devoir",
  "Bon Mo sure to ena devoir, click yes ou al fr to devoir",
  "Bon Mo sure to ena devoir, click yes ou al fr to devoir",
  "At this point to pas pe click yes. Donc Aret zouer ar sa, ek al fr to devoir ou assignment",
];
    ...
    >
      {!isValentine
        ? (
          <>
            <img src={firstImg} />
            <h1>Tanya... Will you be my Valentine? 💘</h1>
            <div>
              <button
                onClick={handleYes}
                style={{
